...
Trucks.prototype.onStartOrLeavingStation = function(result, truck, state) {
    ...
    if (destination !== undefined && destination !== null) {
        _trucksDestinations.push(destination.id);
...
NodeStation.prototype.computeScore = function(context, truck) {
    var _this = this;
    ...
    function mineStations(context) {
        return _.filter(context.stations, function(station) {
            return station.owner && station.owner.id == _this.id;
        });
    }

    if (_.contains(_trucksDestinations, _this.station.id)) {
        _this.score = -1000;
        return;
    }
    if (mineStations(context) >= CONSTANTES.MAX_STATIONS && CONSTANTES.MAX_STATIONS > 0) {
        _this.score = -10000;
        return;
    }
...
State.prototype.analyze = function(truck) {
    ...
    _.forEach(_this.nodes, function(node) {
        ...
        node.computeScore(_this.context, truck);
    });
