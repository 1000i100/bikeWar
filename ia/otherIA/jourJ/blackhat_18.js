...
MyIA.prototype = $extend(WorkerIA.prototype,{
	...
	,getStationScore: function(station,truck) {
		...
		if(this.canSteal(station,truck)) stationScore = stationScore / 30; else if(this.mustProtect(station,truck)) stationScore = stationScore / 25;
		return stationScore;
	}
