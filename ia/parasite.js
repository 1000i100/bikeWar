...
var suivre = function (donneePartie) {
	...
	var mesCamionsMouvant = getCamionsEnMouvement(mesCamions);
	var stationsEnnemis = getStationEnnemis(monId, donneePartie.stations);
	mesCamionsDispo = envoyerSiPossibleCamionsVersStations(mesCamionsDispo, stationsEnnemis); // retourne les camions toujours dispo.
